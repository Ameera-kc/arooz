# Generated by Django 4.1.3 on 2022-12-12 07:12
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rentalsecurity', models.CharField(blank=True, max_length=250, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product', models.ForeignKey(default='', null=True, on_delete=django.db.models.deletion.CASCADE, to='user.product')),
                ('user', models.ForeignKey(default='', null=True, on_delete=django.db.models.deletion.CASCADE, to='user.customer')),
            ],
        ),
        migrations.AddField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('sleevelength', models.CharField(default=0, max_length=150, null=True)),
                ...
                ('LengthTrouser', models.CharField(default=0, max_length=150, null=True)),
                ('hip', models.CharField(default=0, max_length=150, null=True)),
                ('WaistForTrouser', models.CharField(default=0, max_length=150, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('event', models.ForeignKey(default='', null=True, on_delete=django.db.models.deletion.CASCADE, to='user.event')),
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='user.product')),
                ('user', models.ForeignKey(default='', null=True, on_delete=django.db.models.deletion.CASCADE, to='user.customer')),
            ],
        ),
